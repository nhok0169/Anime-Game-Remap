...
FileDownloadData = {
    ...
    4.4: {ModTypeNames.GanyuTwilight.value: {"head": {"ps-t1": ("Diffuse", FileDownload(f"{GithubDownloadFolder}/GI/GanyuTwilight/4_4/GanyuTwilightHeadDiffuse.dds", "GanyuTwilightHeadDiffuse.dds")),
          ...
          ModTypeNames.XingqiuBamboo.value: {"head": {"ps-t0": ("Diffuse", FileDownload(f"{GithubDownloadFolder}/GI/XingqiuBamboo/4_0/XingqiuBambooHeadDiffuse.dds", "XingqiuBambooHeadDiffuse.dds")),
                                                      "ps-t1": ("LightMap", FileDownload(f"{GithubDownloadFolder}/GI/XingqiuBamboo/4_0/XingqiuBambooHeadLightMap.dds", "XingqiuBambooHeadLightMap.dds"))},
                                             "body": {"ps-t0": ("Diffuse", FileDownload(f"{GithubDownloadFolder}/GI/XingqiuBamboo/4_0/XingqiuBambooBodyDiffuse.dds", "XingqiuBambooBodyDiffuse.dds")),
                                                      "ps-t1": ("LightMap", FileDownload(f"{GithubDownloadFolder}/GI/XingqiuBamboo/4_0/XingqiuBambooBodyLightMap.dds", "XingqiuBambooBodyLightMap.dds"))},
                                             "dress": {"ps-t0": ("Diffuse", FileDownload(f"{GithubDownloadFolder}/GI/XingqiuBamboo/4_0/XingqiuBambooDressDiffuse.dds", "XingqiuBambooDressDiffuse.dds")),
                                                       "ps-t1": ("LightMap", FileDownload(f"{GithubDownloadFolder}/GI/XingqiuBamboo/4_0/XingqiuBambooDressLightMap.dds", "XingqiuBambooDressLightMap.dds"))}}},
