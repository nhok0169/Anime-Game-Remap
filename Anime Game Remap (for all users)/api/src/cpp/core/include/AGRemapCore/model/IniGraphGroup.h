...
namespace AGRemapCore {
    ...
    //   src/model/IniGraphGroupInstantiation.cpp, instead. Any other instantiation still happens implicitly.
    extern template class IniGraphGroup<std::string, std::string>;
}
