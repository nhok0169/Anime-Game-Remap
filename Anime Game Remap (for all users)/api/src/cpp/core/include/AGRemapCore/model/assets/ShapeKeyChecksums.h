#ifndef AGRemapCore_ShapeKeyChecksums_H
#define AGRemapCore_ShapeKeyChecksums_H
...
namespace AGRemapCore {
     ...
     * @brief
     ...
     @endrst
     */
    class ShapeKeyChecksums: public ModMappedAssets<std::string, std::string> {
        public:
            /**
             ...
             */
            explicit ShapeKeyChecksums(std::unordered_map<std::string, std::vector<std::string>> map = {});
    };
}
