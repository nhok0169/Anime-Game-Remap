...
namespace AGRemapCore {
    ...
    //   src/model/iftemplate/IfContentPartColourInstantiation.cpp, instead. Any other instantiation still happens implicitly.
    extern template class IfContentPartColouring<std::string, std::string>;
}
