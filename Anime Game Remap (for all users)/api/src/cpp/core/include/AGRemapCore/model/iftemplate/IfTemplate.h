...
namespace AGRemapCore {
    ...
    //   src/model/iftemplate/IfTemplateInstantiation.cpp, instead. Any other instantiation still happens implicitly.
    extern template class IfTemplate<std::string, std::string>;
}
