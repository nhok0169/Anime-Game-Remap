...
namespace AGRemapCore {
    ...
    //   src/model/iftemplate/IfTemplateNodeInstantiation.cpp, instead. Any other instantiation still happens implicitly.
    extern template class IfTemplateNode<std::string, std::string>;
}
