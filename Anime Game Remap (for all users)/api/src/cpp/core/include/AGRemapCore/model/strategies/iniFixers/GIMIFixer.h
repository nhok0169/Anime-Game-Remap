...
namespace AGRemapCore {
    ...
    //   src/model/strategies/iniFixers/GIMIFixerInstantiation.cpp, instead. Any other instantiation still happens implicitly.
    extern template class GIMIFixer<std::string, std::string>;
}
