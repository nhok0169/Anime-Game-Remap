...
namespace AGRemapCore {
    ...
    //   src/model/strategies/iniFixers/RemapIniFixContextInstantiation.cpp, instead. Any other instantiation still happens implicitly.
    extern template class RemapIniFixContext<std::string, std::string>;
}
