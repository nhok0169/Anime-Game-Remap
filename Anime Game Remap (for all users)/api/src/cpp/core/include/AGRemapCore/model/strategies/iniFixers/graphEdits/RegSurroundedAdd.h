...
namespace AGRemapCore {
    ...
    //   src/model/strategies/iniFixers/graphEdits/RegSurroundedAddInstantiation.cpp, instead. Any other instantiation still happens implicitly.
    extern template class RegSurroundedAdd<std::string, std::string>;
}
