...
namespace AGRemapCore {
    ...
    //   src/model/strategies/iniFixers/graphGroupEdits/GraphGroupRemapInstantiation.cpp, instead. Any other instantiation still happens implicitly.
    extern template class GraphGroupRemap<std::string, std::string>;
}
