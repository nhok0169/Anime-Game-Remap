...
namespace AGRemapCore {
    ...
    //   src/model/strategies/iniParsers/BaseIniParserInstantiation.cpp, instead. Any other instantiation still happens implicitly.
    extern template class BaseIniParser<std::string, std::string>;
}
