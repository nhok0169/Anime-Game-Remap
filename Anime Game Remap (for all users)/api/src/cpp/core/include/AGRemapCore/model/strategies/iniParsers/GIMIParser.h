...
namespace AGRemapCore {
    ...
    //   src/model/strategies/iniParsers/GIMIParserInstantiation.cpp, instead. Any other instantiation still happens implicitly.
    extern template class GIMIParser<std::string, std::string>;
}
