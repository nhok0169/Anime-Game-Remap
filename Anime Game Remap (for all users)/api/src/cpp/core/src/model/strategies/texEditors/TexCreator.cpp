...
namespace AGRemapCore {
    ...
    TexCreator::TexCreator(int width, int height, Colour colour, bool compress, bool mipmaps):
        width(width), height(height), colour(colour), compress(compress), mipmaps(mipmaps) {}
