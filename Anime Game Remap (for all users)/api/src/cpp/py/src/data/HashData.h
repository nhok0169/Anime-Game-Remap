#ifndef AGRemapPyBind_HashData_H
#define AGRemapPyBind_HashData_H
...
namespace AGRemapPyBind {
    namespace Data {

        /**
         * @brief
         @rst
         The hash data table backing :class:`Hashes` -- the C++-side replacement for the pure-Python
