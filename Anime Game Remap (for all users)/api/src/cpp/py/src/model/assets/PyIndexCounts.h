#ifndef AGRemapPyBind_PyIndexCounts_H
#define AGRemapPyBind_PyIndexCounts_H
 ...
 * @brief
 @rst
 The `pybind11`_ bound ``IndexCounts`` class -- the exact same pattern as ``Indices`` (see
 :cpp:class:`PyIndices`'s note): one *specific*, pre-populated ``ModMappedAssets`` with its data
 (:cpp:func:`AGRemapCore::Data::getIndexCountDataRows`) and its non-version index names
