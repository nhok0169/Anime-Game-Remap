#ifndef AGRemapPyBind_PyVGOffsets_H
#define AGRemapPyBind_PyVGOffsets_H
 ...
 * @brief
 @rst
 The `pybind11`_ bound ``VGOffsets`` class -- the exact same pattern as ``Indices`` (see
 :cpp:class:`PyIndices`'s note): one *specific*, pre-populated ``ModMappedAssets`` with its data
 (:cpp:func:`AGRemapCore::Data::getVGOffsetDataRows`) and its non-version index names
