...
class PyAhoCorasickDFA: public AGRC::BaseAhoCorasickDFA<py::object> {
    public:
        ...
        virtual std::variant<std::tuple<std::optional<std::string>, size_t>, std::tuple<std::vector<std::string>, std::vector<size_t>>> pyFindMaximal(const std::string &txt, size_t count = 1);
        virtual std::variant<std::tuple<std::optional<std::string>, py::object>, std::tuple<std::vector<std::string>, std::vector<py::object>>> pyGetMaximal(const std::string &txt, bool errorOnNotFound = true, const py::object &defaultVal = py::object(), size_t count = 1);
...
class PyBindAhoCorasickDFA: public PyAhoCorasickDFA {
    public:
        ...
        std::variant<std::tuple<std::optional<std::string>, size_t>, std::tuple<std::vector<std::string>, std::vector<size_t>>> pyFindMaximal(const std::string &txt, size_t count = 1) override;
        std::variant<std::tuple<std::optional<std::string>, py::object>, std::tuple<std::vector<std::string>, std::vector<py::object>>> pyGetMaximal(const std::string &txt, bool errorOnNotFound = true, const py::object &defaultVal = py::object(), size_t count = 1) override;
