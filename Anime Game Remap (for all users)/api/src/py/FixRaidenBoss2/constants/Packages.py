...
class PackageInstall(Enum):
    ...
    Regex = "regex"
    """
    Package for more sophisticated regexes not provided by `python's builtin regex`_
    """
...
class PackageModules(Enum):
    ...
    Regex: :class:`PackageData`
        Module for the `regex library`_
    ...
    Sympy_Logic_Inference: :class:`PackageData`
        Module for sympy.logic.inference
    """
    ...
    Sympy_Logic_Inference = PackageData("sympy.logic.inference", PackageInstall.Sympy.value)
##### EndScript