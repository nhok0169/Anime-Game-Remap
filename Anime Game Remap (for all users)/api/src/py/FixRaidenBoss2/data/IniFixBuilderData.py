...
class IniFixBuilderFuncs():
    ...
    @classmethod
    def amber5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, [],
                {"postRegEditFilters": [RegRemapOld(remap = {"head": cls.IbRemapData,
                                                          "body": cls.IbRemapData}),
                                        OldRegNewVals(vals = {"head": cls.IbDrawIndexedRename,
                                                           "body": cls.IbDrawIndexedRename}),
                                        RegRemapOld(remap = {"head": cls.IbTempToDrawIndexed,
                                                          "body": cls.IbTempToDrawIndexed})],
                 "postModelRegEditFilters": [OldRegNewVals(vals = cls.IbHashToNull)]})
    
    @classmethod
    def amberCN4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, [], {})
    
    @classmethod
    def amberCN5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, [],
                {"postRegEditFilters": [RegRemapOld(remap = {"head": cls.IbRemapData,
                                                          "body": cls.IbRemapData}),
                                        OldRegNewVals(vals = {"head": cls.IbDrawIndexedRename,
    ...
    @classmethod
    def ayaka4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
                       ...
                       OldRegNewVals({"head": {**cls.ORFixValRename, **cls.TexFXToNormalValRename4_0},
                                   "body": {**cls.ORFixValRename, **cls.TexFXToNormalValRename4_0}}),
                       RegRemapOld(remap = {"head": {**cls.TexFXTempToRun},
                                         "body": {**cls.TexFXTempToRun}}),
                       RegRemapOld(remap = {"head": {**cls.ORFixTempToRun},
                                         "body": {**cls.ORFixTempToRun}})
                ]})
    
    @classmethod
    def ayaka5_4(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
                       ...
                       OldRegNewVals({"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.TexFXToNormalValRename5_0},
    ...
    @classmethod
    def ayaka5_6(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
                       ...
                       RegTexAdd(textures = {"head": {"ps-t0": ("NormalMap", TexCreator(1024, 1024, colour = Colours.NormalMapPurple1.value))},
                                             "body": {"ps-t0": ("NormalMap", TexCreator(1024, 1024, colour = Colours.NormalMapPurple1.value))}}, mustAdd = False),
                       OldRegNewVals({"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.IbDrawIndexedRename, **cls.TexFXToNormalValRename5_0},
    ...
    @classmethod
    def ayaka5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
                       ...
                       RegTexAdd(textures = {"head": {"ps-t0": ("NormalMap", TexCreator(1024, 1024, colour = Colours.NormalMapPurple1.value))},
                                             "body": {"ps-t0": ("NormalMap", TexCreator(1024, 1024, colour = Colours.NormalMapPurple1.value))}}, mustAdd = False),
                       OldRegNewVals({"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.IbDrawIndexedRename},
    ...
    @classmethod
    def ayakaSpringbloom4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
                    ...
                    OldRegNewVals(vals = {"head": {**cls.TexFxNoNormalValRename4_0},
    ...
    @classmethod
    def ayakaSpringbloom5_6(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"head": ["body", "body"], "body": ["head", "body"], "dress": ["dress", "dress"]}], 
                {
                 "preRegEditFilters": [
                    ...
                    RegRemapOld(remap = {"head": {"ps-t1": ["ps-t0"], "ps-t2": ["ps-t1"], **cls.TexFxTempRegRemap, **cls.IbRemapData},
                                      ...
                                      "dress": cls.IbRemapData}),
                    OldRegNewVals(vals = {"head": {**cls.TexFxNoNormalValRename5_0, **cls.IbDrawIndexedRename},
                ...
                "postRegEditFilters": [OldRegNewVals({"head": {"ib": "null"}})],
                "copyPreamble": IniComments.GIMIObjMergerPreamble.value,
                "iniPostModelRegEditFilters": [[OldRegNewVals(vals = cls.IbHashToNull)], [OldRegNewVals(vals = cls.IbHashToNull)]]})
    
    @classmethod
    def ayakaSpringbloom5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"head": ["body", "body"], "body": ["head", "body"], "dress": ["dress", "dress"]}], 
                {
                 "preRegEditFilters": [
                    ...
                    OldRegNewVals(vals = {"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.IbDrawIndexedRename},
                                       "body": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.IbDrawIndexedRename},
                                       "dress": cls.IbDrawIndexedRename}),
                    RegRemapOld(remap = {"head": {**cls.ORFixTempToRun},
                                      "body": {**cls.ORFixTempToRun}}),
    ...
    @classmethod
    def arlecchino5_4(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {"preRegEditFilters": [RegTexEdit({"YellowHeadNormal": ["ps-t0"], "YellowBodyNormal": ["ps-t0"]})]})
    
    @classmethod
    def arlecchino5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer,
                [],
                {"preRegEditFilters": [
    ...
    @classmethod
    def barbara4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, [], {})
    
    @classmethod
    def barbara5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer,
                [],
                {"postRegEditFilters": [
                    RegRemapOld(remap = {"head": cls.IbRemapData,
    ...
    @classmethod
    def barbaraSummertime4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, [], {})
    
    @classmethod
    def barbaraSummertime5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer,
                [],
                {"postRegEditFilters": [
                    RegRemapOld(remap = {"head": cls.IbRemapData,
    ...
    @classmethod
    def cherryHuTao5_3(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"head": ["head", "extra"], "body": ["body", "dress"]}], 
                {
                 "preRegEditFilters": [
                         ...
                         OldRegNewVals(vals = {"head": {**cls.TexFxNoNormalValRename5_0},
    ...
    @classmethod
    def diluc4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer, 
                [{"body": ["body", "dress"]}], 
                {})
    
    @classmethod
    def diluc5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer,
                [{"body": ["body", "dress"]}],
    ...
    @classmethod
    def dilucFlamme4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"body": ["body", "dress"]}], 
                {
                 "copyPreamble": IniComments.GIMIObjMergerPreamble.value, 
    ...
    @classmethod
    def dilucFlamme5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
    ...
    @classmethod
    def fischl4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"body": ["body", "dress"]}], 
                {
                 "copyPreamble": IniComments.GIMIObjMergerPreamble.value})
    ...
    @classmethod
    def fischl5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"head": ["head", "head"], "body": ["body", "dress"]}], 
                {
                 "copyPreamble": IniComments.GIMIObjMergerPreamble.value,
    ...
    @classmethod
    def fischlHighness4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer, 
                [{"body": ["body", "dress"]}], 
                {
                 "preRegEditFilters": [
    ...
    @classmethod
    def fischlHighness5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer, 
                [{"body": ["body", "dress"]}], 
                {
                 "preRegEditOldObj": True,
    ...
    @classmethod
    def ganyu4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [],
                {
                 "preRegEditFilters": [
                    ...
                    RegTexAdd(textures = {"head": {"ps-t0": ("NormalMap", TexCreator(1024, 1024, colour = Colours.NormalMapYellow.value))}}),
                    OldRegNewVals(vals = {"head": {**cls.TexFXToNormalValRename4_0}}),
                    RegRemapOld(remap = {"head": {**cls.TexFXTempToRun}})
                ]})
    
    @classmethod
    def ganyu5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer,
                [],
                {
                 "preRegEditFilters": [
                    ...
                    RegTexEdit(textures = {"DarkDiffuse": ["ps-t1"]}),
                    RegTexAdd(textures = {"head": {"ps-t0": ("NormalMap", TexCreator(1024, 1024, colour = Colours.NormalMapYellow.value))}}),
                    OldRegNewVals(vals = {"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.TexFXToNormalValRename5_0, **cls.IbDrawIndexedRename},
                                       "body": cls.IbDrawIndexedRename,
                                       "dress": cls.IbDrawIndexedRename}),
                    RegRemapOld(remap = {"head": {**cls.TexFXTempToRun}}),
                    RegRemapOld(remap = {"head": cls.ORFixTempToRun}),
    ...
    @classmethod
    def ganyuTwilight4_4(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
    ...
    @classmethod
    def ganyuTwilight5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
    ...
    @classmethod
    def hutao4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer, 
                [{"head": ["head", "extra"], "body": ["body", "dress"]}], 
                {
                 "preRegEditFilters": [
                ...
                "postRegEditFilters": [
                    ...
                    OldRegNewVals(vals = {"head": {"ps-t0": "null", **cls.TexFXToNormalValRename4_0},
    ...
    @classmethod
    def hutao5_6(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer, 
                [{"head": ["head", "extra"], "body": ["body", "dress"]}],
                {
                 "preRegEditOldObj": True,
                ...
                "postRegEditFilters": [
                    ...
                    RegRemapOld(remap = {"head": {"ps-t0": ["ps-t0", "ps-t1"], "ps-t1": ["ps-t2"], **cls.TexFxTempRegRemap},
                                      "dress": {"ps-t0": ["ps-t0", "ps-t1"], "ps-t1": ["ps-t2"], **cls.TexFxTempRegRemap}}),
                    OldRegNewVals(vals = {"head": {"ps-t0": "null", **cls.TexFXToNormalValRename5_0},
                ...
                [{ModTypeNames.JeanCN.value: IniFixBuilder(GIMIObjRegEditFixer, kwargs = {}), 
                  ModTypeNames.JeanSea.value: IniFixBuilder(GIMIObjSplitFixer, 
                                                            ...
                                                            kwargs = {
                                                                ...
                                                                "postRegEditFilters": [
                                                                    OldRegNewVals(vals = {"dress": {"ib": "null"}}),
    ...
    @classmethod
    def jeanSea4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"body": ["body", "dress"]}], 
                {
                 "copyPreamble": IniComments.GIMIObjMergerPreamble.value})
    ...
    @classmethod
    def kaeya4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer,
                [],
                {"postRegEditFilters": [
                    ...
                    RegRemapOld(remap = {"body": {**cls.TexFXTempToRun}}),
                    RegRemapOld(remap = {"body": cls.ORFixTempToRun})
                ]})
    
    @classmethod
    def kaeya5_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer,
                [],
                {"postRegEditFilters": [
                    RegRemoveOld(remove = {"body": {*cls.TexFxRemove}}),
    ...
    @classmethod
    def kaeyaSailwind4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer,
                ...
                {"preRegEditFilters": [
                    ...
                    OldRegNewVals(vals = {"body": {**cls.TexFxNoNormalValRename4_0}}),
                    RegRemapOld(remap = {"body": {**cls.TexFXTempToRun}})
                ]})

    @classmethod
    def kaeyaSailwind5_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer,
                [{"head": ["head"], "body": ["body"], "dress": ["dress", "extra"]}],
                {"preRegEditFilters": [
                    RegRemoveOld(remove = {"head": {*cls.ReflectionHeadRemove},
                                        ...
                                        "dress": {*cls.ReflectionDressRemove}}),
                    RegRemapOld(remap = {"body": {"ps-t1": ["ps-t0"], "ps-t2": ["ps-t1"], "ps-t3": ["ps-t2"], **cls.TexFxTempRegRemap}}),
                    OldRegNewVals(vals = {"body": {**cls.TexFxNoNormalValRename5_0}}),
                    RegRemapOld(remap = {"body": {**cls.TexFXTempToRun}})
                ]})
    
    @classmethod
    def keqing4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"head": ["dress", "head"]}], 
                {
    ...
    @classmethod
    def keqingOpulent4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer, 
    ...
    @classmethod
    def kirara4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [],
                {
                 "preRegEditFilters": [
    ...
    @classmethod
    def kirara5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [],
                {
                    "preRegEditFilters": [
                    ...
                    RegRemapOld(remap = {"head": {"ps-t2": ["ps-t2", cls.ORFixTempReg], **cls.TexFxTempRegRemap},
                                      ...
                                      "dress": {"ps-t1": KeyRemapData.build([("ps-t0", cls._remapIsDiffuse)], keepKeyWithoutRemap = True), 
                                                ...
                                                **cls.TexFxTempRegRemap}}),
                    OldRegNewVals(vals = {"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.TexFxNoNormalValRename5_0},
    ...
    @classmethod
    def kiraraBoots4_8(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
                    RegRemapOld(remap = {"dress": {"ps-t0": ["ps-t0", "ps-t1"], "ps-t1": ["ps-t2"]}}),
                    RegTexAdd(textures = {"dress": {"ps-t0": ("NormalMap", TexCreator(1024, 1024, colour = Colours.NormalMapYellow.value))}}, mustAdd = False)
                ]})
    
    @classmethod
    def kiraraBoots5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
                    ...
                    OldRegNewVals(vals = {"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.TexFxNoNormalValRename5_0},
                                       "body": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.TexFxNoNormalValRename5_0}}),
                    RegRemapOld(remap = {"head": {"tempNorm": ["ps-t0"], **cls.TexFXTempToRun},
                                      "body": {**cls.TexFXTempToRun}}),
                    RegRemapOld(remap = {"head": cls.ORFixTempToRun,
                                      "body": cls.ORFixTempToRun})
                ]})
    ...
    @classmethod
    def klee4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer, 
                [{"body": ["body", "dress"]}], 
                {
                 "preRegEditFilters": [
                    RegTexEdit(textures = {"GreenLightMap": ["ps-t1"]}),
                    RegRemapOld(remap = {"head": {"ps-t2": ["ps-t3"]}})
                ]})
    
    @classmethod
    def kleeBlossomingStarlight4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"body": ["body", "dress"]}], 
                {
                 "copyPreamble": IniComments.GIMIObjMergerPreamble.value, "preRegEditFilters": [
    ...
    @classmethod
    def lisa4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer,
                [{"head": ["head"], "body": ["body", "dress"]}],
                {
                 "copyPreamble": IniComments.GIMIObjMergerPreamble.value, "preRegEditFilters": [
    ...
    @classmethod
    def lisa5_4(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer,
                [{"head": ["head"], "body": ["body", "dress"]}],
                {
                 "copyPreamble": IniComments.GIMIObjMergerPreamble.value, "preRegEditFilters": [
                ...
                "postRegEditFilters": [
                    ...
                    OldRegNewVals(vals = {"head": {**cls.TexFXToNormalValRename5_0},
    ...
    @classmethod
    def lisa5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer,
                [{"head": ["head"], "body": ["body", "dress"]}],
                {
                 "copyPreamble": IniComments.GIMIObjMergerPreamble.value, "preRegEditFilters": [
    ...
    @classmethod
    def lisaStudent4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer,
                [{"body": ["body", "dress"]}],
                {
                 "preRegEditOldObj": True,
                ...
                "postRegEditFilters": [
                    RegRemapOld(remap = {"body": {"ps-t3": ["ps-t2"]}})
                ]})
    
    @classmethod
    def mona4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, [], {})
    
    @classmethod
    def monaCN4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, [], {})
    
    @classmethod
    def nilou4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
                    ...
                    OldRegNewVals(vals = {"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.TexFxNoNormalValRename4_0},
    ...
    @classmethod
    def nilou5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
                    ...
                    OldRegNewVals(vals = {"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value},
    ...
    @classmethod
    def nilouBreeze4_8(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
                    ...
                    OldRegNewVals(vals = {"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.TexFXToNormalValRename4_0},
    ...
    @classmethod
    def nilouBreeze5_4(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
                    ...
                    RegRemapOld(remap = {"head": {"ps-t0": ["ps-t0", "ps-t1"], "ps-t1": ["ps-t2", cls.ORFixTempReg], "ps-t2": ["ps-t3"], **cls.TexFxTempRegRemap},
                                        "dress": {"ps-t0": ["ps-t0", "ps-t1"], "ps-t1": ["ps-t2", cls.ORFixTempReg], "ps-t2": ["ps-t3"], **cls.TexFxTempRegRemap},
                                        "body": {"ps-t0": ["ps-t0", "ps-t1"], "ps-t1": ["ps-t2", cls.ORFixTempReg], "ps-t2": ["ps-t3"], **cls.TexFxTempRegRemap}}),
                    OldRegNewVals(vals = {"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value, **cls.TexFXToNormalValRename5_0},
    ...
    @classmethod
    def nilouBreeze5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [], 
                {
                 "preRegEditFilters": [
    ...
    @classmethod
    def ningguang4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, 
                [],
                {
                 "preRegEditFilters": [
    ...
    @classmethod
    def ningguangOrchid4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, [], {})
    
    @classmethod
    def rosaria4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, [], {})
    
    @classmethod
    def rosariaCN4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjRegEditFixer, [], {})
    
    @classmethod
    def shenhe4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer, 
                [{"dress": ["dress", "extra"]}], 
                {
                 "preRegEditFilters": [
    ...
    @classmethod
    def shenheFrostFlower4_4(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"body": ["body", "extra"]}], 
                {
                 "copyPreamble": IniComments.GIMIObjMergerPreamble.value})
    ...
    @classmethod
    def shenheFrostFlower5_7(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"head": ["head", "head", "head"], "body": ["head", "body", "extra"]}], 
                {
                 "copyPreamble": IniComments.GIMIObjMergerPreamble.value,
                 "postRegEditFilters": [
                     OldRegNewVals(vals = {"head": {"ib": "null"}})
                 ]})
    
    @classmethod
    def xiangling4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                ...
                "postRegEditFilters": [
                    OldRegNewVals(vals = {"body": {IniKeywords.Ib.value: "null"}}),
                    RegRemapOld(remap = {"head": {"ps-t2": ["ps-t2", cls.ORFixTempReg]}}),
                    OldRegNewVals(vals = {"head": {cls.ORFixTempReg: IniKeywords.ORFixPath.value}}),
                    RegRemapOld(remap = {"head": {**cls.ORFixTempToRun}})
                ]})
    
    @classmethod
    def xianglingCheer5_3(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer,
                ...
                "postRegEditFilters": [
                    OldRegNewVals(vals = {"head": {IniKeywords.Ib.value: "null"}})
                ]})
    
    @classmethod
    def xingqiu4_0(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjSplitFixer, 
                [{"head": ["head", "dress"]}], 
                {
                 "postRegEditFilters": [
    ...
    @classmethod
    def xingqiuBamboo4_4(cls) -> Tuple[BaseIniFixerOld, List[Any], Dict[str, Any]]:
        return (GIMIObjMergeFixer, 
                [{"head": ["head", "dress"]}], 
                {
                 "copyPreamble": IniComments.GIMIObjMergerPreamble.value,
