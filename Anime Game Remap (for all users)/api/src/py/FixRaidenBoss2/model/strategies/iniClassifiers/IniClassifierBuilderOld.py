...
class IniClassifierBuilderOld(BaseIniClassifierBuilderOld):
    ...
    def build(self, classifier: "IniClassifierOld"):
        ...
        self.addGIModType(classifier, ModTypes.Amber, {"amber": re.compile(r"^\s*\[\s*textureoverride.*(amber)((?!cn).)*\]")})
        self.addGIModType(classifier, ModTypes.AmberCN, {"ambercn": re.compile(r"^\s*\[\s*textureoverride.*(ambercn).*\]")})
        self.addGIModType(classifier, ModTypes.Ayaka, {"ayaka": re.compile(r"^\s*\[\s*textureoverride.*(ayaka)((?!(springbloom)).)*\]")})
        self.addGIModType(classifier, ModTypes.AyakaSpringBloom, {"ayakaspringbloom": re.compile(r"^\s*\[\s*textureoverride.*(ayakaspringbloom).*\]")})
        self.addGIModType(classifier, ModTypes.Arlecchino, {"arlecchino": re.compile(r"^\s*\[\s*textureoverride.*(arlecchino).*\]")})
        self.addGIModType(classifier, ModTypes.Barbara, {"barbara": re.compile(r"^\s*\[\s*textureoverride.*(barbara)((?!summertime).)*\]")})
        self.addGIModType(classifier, ModTypes.BarbaraSummertime, {"barbarasummertime": re.compile(r"^\s*\[\s*textureoverride.*(barbarasummertime).*\]")})
        self.addGIModType(classifier, ModTypes.CherryHuTao, {"cherryhutao": re.compile(r"^\s*\[\s*textureoverride.*(cherryhutao).*\]"),
                                                             "hutaocherry": re.compile(r"^\s*\[\s*textureoverride.*(hutaocherry).*\]")})
        self.addGIModType(classifier, ModTypes.Diluc, {"diluc": re.compile(r"^\s*\[\s*textureoverride.*(diluc)((?!flamme).)*\]")})
        self.addGIModType(classifier, ModTypes.DilucFlamme, {"dilucflamme": re.compile(r"^\s*\[\s*textureoverride.*(dilucflamme).*\]")})
        self.addGIModType(classifier, ModTypes.Fischl, {"fischl": re.compile(r"^\s*\[\s*textureoverride.*(fischl)((?!highness).)*\]")})
        self.addGIModType(classifier, ModTypes.FischlHighness, {"fischlhighness": re.compile(r"^\s*\[\s*textureoverride.*(fischlhighness).*\]")})
        self.addGIModType(classifier, ModTypes.Ganyu, {"ganyu": re.compile(r"^\s*\[\s*textureoverride.*(ganyu)((?!(twilight)).)*\]")})
        self.addGIModType(classifier, ModTypes.GanyuTwilight, {"ganyutwilight": re.compile(r"^\s*\[\s*textureoverride.*(ganyutwilight).*\]")})
        self.addGIModType(classifier, ModTypes.HuTao, {"hutao": re.compile(r"^\s*\[\s*textureoverride((?!cherry).)*(hutao)((?!cherry).)*\]")})
        self.addGIModType(classifier, ModTypes.Jean, {"jean": re.compile(r"^\s*\[\s*textureoverride.*(jean)((?!(cn|sea)).)*\]")})
        self.addGIModType(classifier, ModTypes.JeanCN, {"jeancn": re.compile(r"^\s*\[\s*textureoverride.*(jeancn)((?!sea).)*\]")})
        self.addGIModType(classifier, ModTypes.JeanSea, {"jeansea": re.compile(r"^\s*\[\s*textureoverride.*(jeansea)((?!cn).)*\]")})
        self.addGIModType(classifier, ModTypes.Kaeya, {"kaeya": re.compile(r"^\s*\[\s*textureoverride.*(kaeya)((?!(sailwind)).)*\]")})
        self.addGIModType(classifier, ModTypes.KaeyaSailwind, {"kaeyasailwind": re.compile(r"^\s*\[\s*textureoverride.*(kaeyasailwind).*\]")})
        self.addGIModType(classifier, ModTypes.Keqing, {"keqing": re.compile(r"^\s*\[\s*textureoverride.*(keqing)((?!(opulent)).)*\]")})
        self.addGIModType(classifier, ModTypes.KeqingOpulent, {"keqingopulent": re.compile(r"^\s*\[\s*textureoverride.*(keqingopulent).*\]")})
        self.addGIModType(classifier, ModTypes.Kirara, {"kirara": re.compile(r"^\s*\[\s*textureoverride.*(kirara)((?!boots).)*\]")})
        self.addGIModType(classifier, ModTypes.KiraraBoots, {"kiraraboots": re.compile(r"^\s*\[\s*textureoverride.*(kiraraboots).*\]")})
        self.addGIModType(classifier, ModTypes.Klee, {"klee": re.compile(r"^\s*\[\s*textureoverride.*(klee)((?!blossomingstarlight).)*\]")})
        self.addGIModType(classifier, ModTypes.KleeBlossomingStarlight, {"kleeblossomingstarlight": re.compile(r"^\s*\[\s*textureoverride.*(kleeblossomingstarlight).*\]")})
        self.addGIModType(classifier, ModTypes.Lisa, {"lisa": re.compile(r"^\s*\[\s*textureoverride.*(lisa)((?!student).)*\]")})
        self.addGIModType(classifier, ModTypes.LisaStudent, {"lisastudent": re.compile(r"^\s*\[\s*textureoverride.*(lisastudent).*\]")})
        self.addGIModType(classifier, ModTypes.Mona, {"mona": re.compile(r"^\s*\[\s*textureoverride.*(mona)((?!(cn)).)*\]")})
        self.addGIModType(classifier, ModTypes.MonaCN, {"monacn": re.compile(r"^\s*\[\s*textureoverride.*(monacn).*\]")})
        self.addGIModType(classifier, ModTypes.Nilou, {"nilou": re.compile(r"^\s*\[\s*textureoverride.*(nilou)((?!(breeze)).)*\]")})
        self.addGIModType(classifier, ModTypes.NilouBreeze, {"niloubreeze": re.compile(r"^\s*\[\s*textureoverride.*(niloubreeze).*\]")})
        self.addGIModType(classifier, ModTypes.Ningguang, {"ningguang": re.compile(r"^\s*\[\s*textureoverride.*(ningguang)((?!(orchid)).)*\]")})
        self.addGIModType(classifier, ModTypes.NingguangOrchid, {"ningguangorchid": re.compile(r"^\s*\[\s*textureoverride.*(ningguangorchid).*\]")})
        self.addGIModType(classifier, ModTypes.Raiden, {"raiden": re.compile(r"^\s*\[\s*textureoverride.*(raiden).*\]"),
                                                        "shogun": re.compile(r"^\s*\[\s*textureoverride.*(shogun).*\]")})
        self.addGIModType(classifier, ModTypes.Rosaria, {"rosaria": re.compile(r"^\s*\[\s*textureoverride.*(rosaria)((?!(cn)).)*\]")})
        self.addGIModType(classifier, ModTypes.RosariaCN, {"rosariacn": re.compile(r"^\s*\[\s*textureoverride.*(rosariacn).*\]")})
        self.addGIModType(classifier, ModTypes.Shenhe, {"shenhe": re.compile(r"^\s*\[\s*textureoverride.*(shenhe)((?!frostflower).)*\]")})
        self.addGIModType(classifier, ModTypes.ShenheFrostFlower, {"shenhefrostflower": re.compile(r"^\s*\[\s*textureoverride.*(shenhefrostflower).*\]")})
        self.addGIModType(classifier, ModTypes.Xiangling, {"xiangling": re.compile(r"^\s*\[\s*textureoverride.*(xiangling)((?!cheer|newyear).)*\]")})
        self.addGIModType(classifier, ModTypes.XianglingCheer, {"xianglingcheer": re.compile(r"^\s*\[\s*textureoverride.*(xianglingcheer).*\]"),
                                                                "xianglingnewyear": re.compile(r"^\s*\[\s*textureoverride.*(xianglingnewyear).*\]")})
        self.addGIModType(classifier, ModTypes.Xingqiu, {"xingqiu": re.compile(r"^\s*\[\s*textureoverride.*(xingqiu)((?!bamboo).)*\]")})
        self.addGIModType(classifier, ModTypes.XingqiuBamboo, {"xingqiubamboo": re.compile(r"^\s*\[\s*textureoverride.*(xingqiubamboo).*\]")})
