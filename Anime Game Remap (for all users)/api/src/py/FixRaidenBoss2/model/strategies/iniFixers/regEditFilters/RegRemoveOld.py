...
if (TYPE_CHECKING):
    ...
    from ..BaseIniFixer import BaseIniFixerOld
...
class RegRemoveOld(RegEditFilter):
    ...
    def _editReg(self, part: IfContentPart, modType: "ModType", fixModName: str, obj: str, sectionName: str, fixer: "BaseIniFixerOld") -> IfContentPart:
        try:
