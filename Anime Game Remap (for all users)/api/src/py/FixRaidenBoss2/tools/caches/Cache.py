...
class Cache(Generic[T]):
    ...
    def get(self, key: Hashable, default: Any = None):
        """
        Attempts to get an item from the cache. If the item is not available, return a default value
        ...
        default: Any
            The default value to return if the item is not found :raw-html:`<br />` :raw-html:`<br />`
