...
class CommandBuilder():
    ...
    def _addArguments(self):
        ...
        self._argParser.add_argument('-a', AllOpt, action='store_true', help=f'Parses all {FileTypes.Ini.value}s that the program encounters. This option supersedes the {TypesOpt} option')
        ...
        self._argParser.add_argument('-t', TypesOpt, action='store', type=str, help=f'''Parses {FileTypes.Ini.value}s that the program encounters for only specific types of mods. If the {AllOpt} option has been specified, this option has no effect. 
