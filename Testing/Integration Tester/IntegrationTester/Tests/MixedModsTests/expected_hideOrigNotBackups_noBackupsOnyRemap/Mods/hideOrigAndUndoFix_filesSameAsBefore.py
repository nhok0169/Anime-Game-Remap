...
fixService = FRB.RemapServiceCLI(path = iniRunPath, verbose = False, log = prevLogPath, readAllInis = True, hideOrig = True, downloadMode = "disabled")
fixService.fix()

fixService.service.clear()
fixService.log = logPath
fixService.service.undoOnly = True
fixService.fix()
