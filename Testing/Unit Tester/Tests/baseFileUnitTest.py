...
class BaseFileUnitTest(BaseUnitTest):
    ...
    def setUp(self):
        ...
        self.patch("src.FixRaidenBoss2.FixRaidenBoss2.os.listdir", side_effect = lambda root: self.listDir(self._currentFolderTree))
        self.patch("src.FixRaidenBoss2.FixRaidenBoss2.os.path.isfile", side_effect = self.isFile)
        self.patch("src.FixRaidenBoss2.FixRaidenBoss2.os.path.join", side_effect = lambda path1, path2: self.osPathJoin(path1, path2))
        self.patch("src.FixRaidenBoss2.FixRaidenBoss2.os.walk", side_effect = lambda path, topdown: self.fileWalk(path, self._currentFolderTree))
        self.patch("src.FixRaidenBoss2.FixRaidenBoss2.os.rename", side_effect = lambda oldFile, newFile: self.fileRename(oldFile, newFile))
        self.patch("src.FixRaidenBoss2.FixRaidenBoss2.os.remove", side_effect = lambda file: self.fileRemove(file))
