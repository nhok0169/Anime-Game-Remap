...
class RemapServiceTest(BaseFileUnitTest):
    ...
    def setupFixIni(self):
        self.patch("src.FixRaidenBoss2.FixRaidenBoss2.RemapService.fixIni", side_effect = lambda ini, mod, fixedRemapBlend: self.fixIni(ini))

    def getMockFixIni(self) -> mock.MagicMock:
        return self.patches["src.FixRaidenBoss2.FixRaidenBoss2.RemapService.fixIni"]
    ...
    @mock.patch("src.FixRaidenBoss2.FixRaidenBoss2.RemapService.clear")
    @mock.patch("src.FixRaidenBoss2.FixRaidenBoss2.RemapService._setupModPath")
