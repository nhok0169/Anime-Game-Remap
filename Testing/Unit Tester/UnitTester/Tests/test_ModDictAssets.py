...
class ModDictAssetsTest(BaseUnitTest):
    ...
    @mock.patch("src.FixRaidenBoss2.ModDictAssets.clear")
    @mock.patch("src.FixRaidenBoss2.ModDictAssets.loadPredefinedFromAssets")
    @mock.patch("src.FixRaidenBoss2.ModDictAssets.loadPredefinedToAssets")
