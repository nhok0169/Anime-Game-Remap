...
class ResRegCollectTest(BaseIniFileTest):
    ...
    def test_differentInis_blendResourcesCollected(self):
        self.create()
        self._fixer.graphGroupEdits = [FRB.ResRegCollect({(0, "", "blend"): "vb1"}, FRB.RemapBlendReplace((0, "", "remapBlend")))]
...
; ----------------------------------------"""
    ...
    def test_differentInis_textureCreateCollected(self):
        self.create()
        self._fixer.graphGroupEdits = [FRB.ResRegCollect({(0, "head", ""): "ps-t0", (0, "body", ""): "ps-t1"}, FRB.TexCreate((0, "", "remapNormalTex"), "NormalMap", FRB.TexCreator(512, 512)))]
