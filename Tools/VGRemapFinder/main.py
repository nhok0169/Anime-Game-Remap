...
if __name__ == "__main__":
    ...
    parser.add_argument("--fromHashes", type = str, nargs = 3, default = None, metavar = ("POSITION", "BLEND", "IB"), help = "when fromFolder is a raw 3dmigoto frame analysis: the mod's position, blend and ib hashes (as in its hash.json), to pick its files out of the thousands there. Give a frame analysis without them to be shown which hashes it holds")
    parser.add_argument("--toHashes", type = str, nargs = 3, default = None, metavar = ("POSITION", "BLEND", "IB"), help = "as --fromHashes, for toFolder")
